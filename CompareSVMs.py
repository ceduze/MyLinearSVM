...
#lambduh is set ot 1 by default
sklearnSVM = LinearSVC()
sklearnSVM.fit(x_train, y_train)
sklearnSVM.predict(x_test)
skSVMMisCalc = (1 - sklearnSVM.score(x_test, y_test))*100
...
print("Misclassification error on test set using MyLinearSVM:",myMisCalc)

print("Misclassification error on test set using SKLearn SVM:",skSVMMisCalc)